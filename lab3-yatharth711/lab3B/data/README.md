...
This dataset is a CC0 Public Domain dataset, available [from Kaggle](https://www.kaggle.com/abcsds/pokemon). 

The description of the data is (reproduced from Kaggle):
